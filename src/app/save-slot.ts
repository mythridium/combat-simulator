...
export abstract class SaveSlot {
    ...
    public static async save(key: string, data: SaveSlotData) {
        if (!this.db) {
            console.error('Cannot save as indexeddb failed to load.');
            return;
        }
        ...
        try {
            ...
            console.error('Failed to save save slot', error, key, data);
        }
    }

    public static async get(key: string) {
        if (!this.db) {
            console.error('Cannot get as indexeddb failed to load.');
            return;
        }
        ...
        try {
            ...
            console.error('Failed to load save slot', error, key);
            return null;
        }
    }
