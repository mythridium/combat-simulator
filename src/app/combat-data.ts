...
export class CombatData {
    ...
    updateCombatStats() {
        ...
        this.combatStats.lootBonusPercent =
            this.micsr.showModifiersInstance.getModifierValue(modifiers, 'ChanceToDoubleLootCombat') +
        ...
        this.combatStats.maxHitpoints += this.micsr.showModifiersInstance.getModifierValue(modifiers, 'MaxHitpoints');
